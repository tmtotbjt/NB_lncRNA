```{r}
# Protein-Protein Interaction nagrinėti + per koreliacijas prie susidariųsių genų grupių pridėti lncRNA
...
### pasikeisk pav
#saveRDS(lncGR, "~/NB_lncRNA/output/code/BioInsights/Curoxin_vs_Control/.RDS")
### pasikeisk pav
...
### pasikeisk pav
#saveRDS(geneGR, "~/NB_lncRNA/output/code/BioInsights/Curoxin_vs_Control/.RDS")
### pasikeisk pav
```
...
### pasikeisk pav
write.csv(ppi, "~/NB_lncRNA/output/code/BioInsights/POS_NEG/PPI_modules.csv", row.names = FALSE)
### pasikeisk pav
```
...
### pasikeisk pav
saveRDS(final_hits, "~/NB_lncRNA/output/code/BioInsights/POS_NEG/POSvsNEG.RDS")
### pasikeisk pav
```
