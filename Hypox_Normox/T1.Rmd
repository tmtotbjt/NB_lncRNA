...
## Pagal raišką
Matoma, jog yra koreliuojančių lncRNA su mRNA
Matoma, jog susidaro tam tikros grupės
```{r}
...
saveRDS(cor_df, "~/NB_lncRNA/output/code/BioInsights/Oxygen/cor_T.RDS")
pheatmap(cor_matrix,
...
Koreliuojantys genai susiję su: reakcija į kintančiį deguonies kiekį, raumenimis (veikla, vystymasis), erakcija į aplinką
```{r}
