...
Turima 51 mazgą ir 74 ryšius tarp ilgųjų nekoduojančių RNR ir baltymų arba baltymo-baltymo

Yra vienas didelis mazgas (47 kompenentai) ir du mažesni.
```{r}
table(V(g)$type)
table(E(g)$edge_type)
...
```{r}
lnc_enrichment_results <- readRDS("~/NB_lncRNA/output/code/BioInsights/graph/lncEn_NBC.RDS")
```
