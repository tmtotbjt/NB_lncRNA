...
```{r}
lncGR <- readRDS("~/NB_lncRNA/output/code/BioInsights/Bastimat/lncGR_NBC_padj.RDS")
geneGR <- readRDS("~/NB_lncRNA/output/code/BioInsights/Bastimat/geneGR_NBC_padj.RDS")
