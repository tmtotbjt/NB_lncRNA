...
## PCA
Matomi skritumai tarp POS ir NEG grupių.
PC1 paiškina didžiąja dalį matomų skirtumų tarp grupių (pagrinde mėginiai skiriasi dėl POS NEG)
```{r}
...
ann_colors = list(Group = c(Batimastat="#54aaaa", control="#e2a4ad"))
