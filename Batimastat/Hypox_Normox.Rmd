...
```{r}
lncGR <- readRDS("~/NB_lncRNA/output/code/BioInsights/Bastimat/lncGR_HN_padj.RDS")
geneGR <- readRDS("~/NB_lncRNA/output/code/BioInsights/Bastimat/geneGR_HN_padj.RDS")
