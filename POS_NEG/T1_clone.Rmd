...
lnc_top <- lnc_res[abs(lnc_res$logFC) > 2 & lnc_res$FDR < 0.05, ]
...
## PCA
Mėginiai pakaniamai stipriai atsiskiria pagal POS NEG (skiriasi pagrinde dėl šio požymio)
```{r}
...
## Koreliacija
Mėginiai tarpusavyje skiriasi pagrinde tik dėl POS NEG
...
- Ląstelės-ląstelės jungtiimis

- Transportu ląstelės memebrana

- Sinapsių veikla, mokymusi
```{r}
