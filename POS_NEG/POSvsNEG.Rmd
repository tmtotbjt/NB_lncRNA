...
```{r}
g <- readRDS( "~/NB_lncRNA/output/code/BioInsights/graph/network_graph_PN.RDS")
V(g)$name <- V(g)$symbol
tg <- readRDS("~/NB_lncRNA/output/code/BioInsights/graph/tbl_PS.rds")
```
## lncRNA charakteristikos
Turima 229 mazgus ir 527 ryšius tarp ilgųjų nekoduojančių RNR ir baltymų arba baltymo-baltymo
...
```{r}
lnc_enrichment_results <- readRDS("~/NB_lncRNA/output/code/BioInsights/graph/lncEn_PN.RDS")
```
