...
mat_group <- mat_all[, c(1, 2, 3, 6, 7, 4, 5)]
mat_lnc_group <- mat_lnc[, c(1, 2, 3, 6, 7, 4, 5)]
mat_pc_group <- mat_pc[, c(1, 2, 3, 6, 7, 4, 5)]

a <- get_cor(mat_lnc_group, title = "lncRNA")
b <-get_cor(mat_pc_group, title = "mRNA")
c <-get_cor(mat_group, title = "Bendras")
...
```{r}
lncGR <- readRDS("~/NB_lncRNA/output/code/BioInsights/Bastimat/lncGR_HBC_padj.RDS") #padarytas su siglncRNAs
