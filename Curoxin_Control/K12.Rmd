...
lnc_top <- lnc_res[abs(lnc_res$logFC) > 1 & lnc_res$PValue < 0.05, ]
...
## Pagal raišką
Matoma, jog tam tikros mRNA koreliuoja su lncRNA.

Matomas ir atskiras klasteris, kuris gali aiškinti K12Cu2 atsiskyrimą nuo kitų mėginių.
```{r}
