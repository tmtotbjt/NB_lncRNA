...
### pasikeisk pav
write.csv(ppi, "~/NB_lncRNA/output/code/BioInsights/POS_NEG/PPI_modules_T1.csv", row.names = FALSE)
### pasikeisk pav
```

```{r, eval = F, echo = F}
### pasikeisk pav
ppi <- read.csv("~/NB_lncRNA/output/code/BioInsights/POS_NEG/PPI_modules_T1.csv")
### pasikeisk pav
...
### pasikeisk pav
saveRDS(final_hits, "~/NB_lncRNA/output/code/BioInsights/POS_NEG/final_hits_T1.RDS")
### pasikeisk pav
```
...
### pasikeisk pav
saveRDS(ego_list, "~/NB_lncRNA/output/code/BioInsights/POS_NEG/GO_en_mod_T1.RDS")
### pasikeisk pav
```
